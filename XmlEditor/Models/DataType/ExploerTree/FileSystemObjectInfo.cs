...
namespace XmlEditor.Models.DataType.ExploerTree
{
    ...
    {
        ImageSource open = new BitmapImage(new Uri("Resources/open.png", UriKind.Relative));
        ImageSource folder = new BitmapImage(new Uri("Resources/folder.png", UriKind.Relative));
        ImageSource xml = new BitmapImage(new Uri("Resources/xml.png", UriKind.Relative));

        //ImageSource open = new BitmapImage(new Uri(@"pack://application:,,,/Resources/open.ico"));
        //ImageSource folder = new BitmapImage(new Uri(@"pack://application:,,,/Resources/folder.ico"));
        //ImageSource xml = new BitmapImage(new Uri(@"pack://application:,,,/Resources/xml.ico"));
        ...
        public bool IsFile
        {
            get { return GetValue<bool>("IsFile"); }
            private set { SetValue("IsFile", value); }
        }
        ...
        private void ExploreDirectories() //добаволение папки
        {
        ...
        private void ExploreFiles() //добавление файлов
        {
            if (Drive?.IsReady == false)
            {
                return;
                ...
                foreach (var file in files.OrderBy(d => d.Name))
                {
                    if ((file.Attributes & FileAttributes.System) != FileAttributes.System &&
                        (file.Attributes & FileAttributes.Hidden) != FileAttributes.Hidden &&
                         Path.GetExtension(file.ToString()).Equals(".xml"))
                    {
